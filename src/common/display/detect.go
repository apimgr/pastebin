...
// SupportsUnicode reports whether the terminal can render Unicode box-drawing
// and status symbols (PART 32, AI.md line 44613). Dumb terminals and
// non-UTF-8 locales fall back to the ASCII symbol set.
func (e *DisplayEnv) SupportsUnicode() bool {
	...
	if locale == "" {
		// No locale info available: assume Unicode-capable terminal.
		return true
	}
